...
import numpy as np
import math
from models.model_factory_predrnn import Model
from models.data_provider import data_provider
...
def train_wrapper(model):
    ...
    train_input_handle, test_input_handle = data_provider(
        args.dataset, args.train_data_paths, args.valid_data_paths, args.batch_size, args.img_width,
